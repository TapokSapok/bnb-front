			...
			<div className={styles.footer_content}>
				<div className={styles.top}>
					<section className={styles.list}>
						<div className={styles.list_title}>Support</div>
						<ul>
							<li>
								<a>Help Center</a>
							</li>
					...
					<section className={styles.list}>
						<div className={styles.list_title}>Hosting</div>
						<ul>
							<li>
					...
					<section className={styles.list}>
						<div className={styles.list_title}>Airbnb</div>
						<ul>
							<li>
								<a>Newsroom</a>
							</li>
				...
				<div className={styles.bottom}>
					<div className={styles.l_side}>
						<div className={styles.inc}>© 2024 Airbnb, Inc.</div>
						<div className={styles.links}>
							...
							<svg style={{ marginLeft: '4px' }} width='26' height='12' fill='none'>
					...
					<div className={styles.r_side}>
						<div className={styles.alt}>
							<img src='../../language.svg' alt='' width={16} />
							English (US)
						</div>
						<div className={styles.alt}>
